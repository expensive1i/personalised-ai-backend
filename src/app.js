...
// CORS configuration
const whitelist = ['https://admin-personalized.vercel.app','https://personalize-production-8a33.up.railway.app', 'https://personalised-ai-backend-production.up.railway.app', 'localhost:5173'];
const corsOptions = {
